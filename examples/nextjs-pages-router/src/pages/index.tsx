...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Fidus UI - Next.js Pages Router Example</title>
        <meta
          name="description"
          content="Example application showcasing @fidus/ui components in Next.js Pages Router"
        />
        ...
        <Stack spacing="xl">
          <div className="text-center py-8">
            ...
            <p className="text-lg text-gray-600">
              Next.js Pages Router Example - No Provider Required
            </p>
          </div>
